        ...
        <div className="home">
            <Container className="py-5 mt-5">
                ...
                <div className="skills">
                    ...
                    <p className="fs-4">I've been self-teaching myself how to code for about a year and a half. The more I expand my development skills, the more I love programming. I love learning new things and using new development technologies. Feel free to check out my projects, and if you feel I may be a good fit for your company, please reach out!</p>
                </div>
